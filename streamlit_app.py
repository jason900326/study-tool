...
def home():
    topbar()
    get_slime_progress(st.session_state.selected_slime)
...
def gacha_page():
    ...
    def do_pull(payment):
        ...
        st.session_state.gacha_pull_count = int(st.session_state.get("gacha_pull_count", 0) or 0) + 1
        if payment == "free":
